    ...
    <div class="panel">
        ...
        <div class="panel-footer">
            <div class="text-center">
                ...
                <asp:LinkButton runat="server" CssClass="btn btn-primary" ID="btnUpdate"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Cập nhật</asp:LinkButton>
                <asp:LinkButton runat="server" CssClass="btn btn-warning" ID="btnCancel"><i class="fa fa-times" aria-hidden="true"></i> Hủy bỏ</asp:LinkButton>
            </div>
        </div>
    </div>
</asp:Content>
